...
This is a PyTorch implementation of Multi-scale Fusion Dynamic Graph Convolutional Recurrent Network for Traffic Forecasting, Junbi Xiao1, Wenjing Zhang, Wenchao Weng, Yuhao Zhou1*, Yunhuan Cong.
